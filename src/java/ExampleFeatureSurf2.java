 ...
 * @author Peter Abeles
 */
public class ExampleFeatureSurf2 {
	...
	public static void main (String[]args){
		...
		GrayF32 image = UtilImageIO.loadImage(UtilIO.pathExample("E:\\webapps\\frontal\\2.jpg"), GrayF32.class);
		
		// run each example
		ExampleFeatureSurf2.easy(image);
		ExampleFeatureSurf2.harder(image);

 ...
 * @author Peter Abeles
 */
public class ExampleFeatureSurf3 {
	...
	public static <II extends ImageGray> void harder(GrayF32 image ) {
        ...
        public String runSurf3(){
            
            int sum = features/10;
            String features3 = Integer.toString(sum);
        return features3;
        
        }
	public static void main (String[]args){
		
		GrayF32 image = UtilImageIO.loadImage(UtilIO.pathExample("E:\\webapps\\frontal\\3.jpg"), GrayF32.class);
		
		// run each example
		ExampleFeatureSurf3.easy(image);
		ExampleFeatureSurf3.harder(image);

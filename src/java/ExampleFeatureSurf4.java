 ...
 * @author Peter Abeles
 */
public class ExampleFeatureSurf4 {
	...
	public static void main (String[]args){
		...
		GrayF32 image = UtilImageIO.loadImage(UtilIO.pathExample("E:\\webapps\\frontal\\4.jpg"), GrayF32.class);
		
		// run each example
		ExampleFeatureSurf4.easy(image);
		ExampleFeatureSurf4.harder(image);

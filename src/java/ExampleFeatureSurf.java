...
public class ExampleFeatureSurf {
	...
	public static <II extends ImageGray> void harder(GrayF32 image ) {
        ...
        public String runSurf(){
            
            int sum = features/10;
            String features2 = Integer.toString(sum);
        return features2;
        
        }
	public static void main (String[]args){
		
		GrayF32 image = UtilImageIO.loadImage(UtilIO.pathExample("E:\\webapps\\frontal\\1.jpg"), GrayF32.class);
